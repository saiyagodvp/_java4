...
<body align="center">
	...
	<form action="/bai3" method="post">
		...
		<div>
			<input name="soThich" type="checkbox" value="Remix">Remix<input
				name="soThich" type="checkbox" value="DJ">DJ <input
				name="soThich" type="checkbox" value="Code">Code<input
				name="soThich" type="checkbox" value="Khac">Khác<br>
		</div>
		...
		<button formaction="/Lab2/bai3">Dang Ky</button>
